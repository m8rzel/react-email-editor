...
let parent = document.getElementById(NWB_QUICK_MOUNT_ID); /* global NWB_QUICK_MOUNT_ID */
...
function renderEntry(exported) {
  ...
  if (Object.prototype.toString.call(exported) === '[object Function]') {
    vnode = (0, _inferno.createComponentVNode)(1 << 1 /* === VNodeFlags.ComponentUnknown */, exported);
  ...
  (0, _inferno.render)(vnode, parent);
}
